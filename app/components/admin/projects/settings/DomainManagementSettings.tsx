      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-4 border border-gray-200 text-left">
        <div className="flex items-center mb-4">
          ...
          <div className="text-left">
            <h3 className="text-lg font-semibold text-gray-800">Domain Enabled</h3>
            <p className="text-gray-600 text-sm">Your project is protected by the following domain:</p>
          </div>
        </div>
      ...
      {showDomainConfirmation && (
        ...
        >
          <div className="flex items-center mb-2">
            ...
            <span className="text-green-900 font-medium">Domain management will help keep your project accessible and protected with a dedicated domain name.</span>
          </div>
          <p className="text-gray-700 text-sm mb-2">Are you sure you want to enable domain management for this project?</p>
